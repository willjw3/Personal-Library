$( document ).ready(function() {
  ...
  $('#newBook').click(function() {
    $.ajax({
      ...
      success: function(data) {
        $('#detailComments').html('<p style="color: red;">'+data+'<p><p>Refresh the page</p>');//update list
      }
    });
  });
  ...
  $('#deleteAllBooks').click(function() {
    $.ajax({
      ...
      data: $('#newBookForm').serialize(),
      success: function(data) {
        $('#detailComments').html('<p style="color: red;">'+data+'<p><p>Nuclear Option exercised as last resort</p>');//update list
      }
    });
  });
